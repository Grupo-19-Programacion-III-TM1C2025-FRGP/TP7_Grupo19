<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoSucursalesSeleccionados.aspx.cs" Inherits="TP7_Grupo19.ListadoSucursalesSeleccionados" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td colspan="3">
                        <asp:Label ID="lblMostrar" runat="server" Font-Bold="True" Font-Size="18pt" Text="Mostrar Sucursales Seleccionadas"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
